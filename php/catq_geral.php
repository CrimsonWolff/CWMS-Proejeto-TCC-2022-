...
<head>
    ...
    <title>Lista Geral de Catequistas</title>
</head>
...
$search = $pdo->prepare("SELECT * FROM catequista order by nome ASC");
$search->execute();
?>
...
<div class="container">
    <div class="row justify-content-center">
        <h1><i class="bi bi-person-fill">Lista Geral de Catequistas<i class="bi bi-person-fill"></h1></i></i>
    </div>
</div>
    ...
    <div class="table-responsive-lg">
        <table class="table table-hover table-striped">
            <thead class="thead-dark">
                <tr>
                    <th class="pl-lg-5" scope="col">Nome</th>
...
?>
    ...
    <div class="col-md-12 text-center">
        <a type="button" class="btn btn-danger" href="menu.php">Voltar ao Menu</a>
    </div>
</div>
