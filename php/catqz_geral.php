...
<head>
    ...
    <title>Lista geral de Catequizando</title>
</head>
...
$search = $pdo->prepare("SELECT * FROM catequizando order by nome ASC");
$search->execute();
?>
...
<div class="container">
    <div class="row justify-content-center">
        <h1><i class="bi bi-person-fill">Lista Geral de Catequizandos<i class="bi bi-person-fill"></h1></i></i>
    </div>
</div>
