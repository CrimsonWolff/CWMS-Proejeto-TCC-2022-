...
//Pesquisa pelos dados na pág "busca_catequizando.html"
$nome=$_POST["nome"];
$data=$_POST["date"];
$nomemae=$_POST["txt_nmae"];
$nomepai=$_POST["txt_npai"];
$search = $pdo->prepare("SELECT * FROM `catequizando` WHERE `nome` LIKE '%$nome%' AND `nasc` LIKE '%$data%' AND `nmae` LIKE '%$nomemae%' AND `npai` LIKE '%$nomepai%' ORDER BY `nome` ASC");
$search->execute();
?>
...
<div class="container">
    <div class="row justify-content-center">
        <h1><i class="bi bi-person-fill">Lista de Catequizandos<i class="bi bi-person-fill"></h1></i></i>
    </div>
</div>
